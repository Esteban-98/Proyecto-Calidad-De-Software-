...
public class AdminDevProDefectuso extends javax.swing.JFrame {
    ...
    PerdidaDAO ppDAO = new PerdidaDAO();
    EntidadPerdida epp = new EntidadPerdida();
    ...
    public AdminDevProDefectuso() {
        initComponents();
        this.setLocationRelativeTo(null);
        this.setTitle("Devolución De Producto Defectuoso");
    }
    ...
    private void initComponents() {
        ...
        jTextFieldVentaId = new javax.swing.JTextField();
        ...
        jTextFieldVentaId.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextFieldVentaIdActionPerformed(evt);
            }
        });
        jTextFieldVentaId.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                jTextFieldVentaIdKeyTyped(evt);
            }
        });
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel5Layout.createSequentialGroup()
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel5Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(jTextFieldProductoCodigo, javax.swing.GroupLayout.PREFERRED_SIZE, 190, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel5Layout.createSequentialGroup()
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel5Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jTextFieldT16, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                ...
                .addGap(25, 25, 25)
                .addComponent(jButtonRealizarCambio, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addContainerGap())
        );
        jPanel5Layout.setVerticalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jButtonRealizarCambio, javax.swing.GroupLayout.PREFERRED_SIZE, 87, javax.swing.GroupLayout.PREFERRED_SIZE))
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jTextFieldVentaId, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel15)
                    .addComponent(jTextFieldVentaId, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jLabel1.setText("DEVOLUCIÓN DE PRODUCTO DEFECTUOSO");
    ...
    private void jTextFieldVentaIdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextFieldVentaIdActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jTextFieldVentaIdActionPerformed
    ...
    public void buscarVenta() {
        ...
        if (jTextFieldVentaId.getText().equals("")) {
            JOptionPane.showMessageDialog(this, "Debe ingresar el ID de la venta, en la caja de texto");
            jTextFieldVentaId.requestFocus();
        } else {
           int idVenta = Integer.parseInt(jTextFieldVentaId.getText());
            ...
            if (ev.getIdVenta() != 0) {
                ...
                buscarDetalle();
                jTextFieldVentaId.setEditable(false);
                jButtonBuscarVenta.setEnabled(false);

            } else {
                JOptionPane.showMessageDialog(this, "El ID de la venta no existe o la venta no esta activa");
                jTextFieldVentaId.requestFocus();
            }
        }
    }
    ...
    public void buscarDetalle() {
        ...
        modelo = (DefaultTableModel) jTableProductosVenta.getModel();
        ...
        jTableProductosVenta.setModel(modelo);
    }
   ...
   public void reiniciarCant(){
    ...
    private void jTableProductosVentaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableProductosVentaMouseClicked
        ...
        if (fila == -1){
            ...
            String productoCodigo = jTableProductosVenta.getValueAt(fila, 0).toString();
            String productoNombre = jTableProductosVenta.getValueAt(fila, 1).toString();
            String productoPrecio = jTableProductosVenta.getValueAt(fila, 2).toString(); 
    ...
    private void jButtonRealizarCambioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonRealizarCambioActionPerformed
        ...
        if (cantT6 < 0 || cantT8 < 0 || cantT10 < 0
            ...
            if (sumaP == 0) {
                ...
                if (cantT6 > T6 || cantT8 > T8 || cantT10 > T10
                    ...
                    agregarPerdida();
                    actualizarVenta();
                    JOptionPane.showMessageDialog(this, "Devolución de producto defectuoso, exitosa");
                    limpiarTabla();
                    reiniciarCant();
                    reiniciarDev();
                    jButtonRealizarCambio.setEnabled(false);
        ...
        //Venta
        jTextFieldVentaId.setText("");
        jTextFieldVentaId.setEditable(true);
    ...
    private void jTextFieldVentaIdKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldVentaIdKeyTyped
               char v = evt.getKeyChar();
        int c = (int) evt.getKeyChar();

        soloNumeros(evt, v, c);
    }//GEN-LAST:event_jTextFieldVentaIdKeyTyped
    ...
    public void actualizarDetalleVenta(){
        ...
        public void agregarPerdida(){
            ...
            int idProducto = ep.getIdProducto();
            double costo =(double) ep.getCosto();
            int CT6 = (int) jSpinnerT6.getValue();
            int CT8 = (int) jSpinnerT8.getValue();
            int CT10 = (int) jSpinnerT10.getValue();
            int CT12 = (int) jSpinnerT12.getValue();
            ...
            double valorPerdida = (CT6+CT8+CT10+CT12+CT14+CT16+CT18+CT20+CT22)* costo;
            String fecha = ""+fechaD;
    ...
    private javax.swing.JTextField jTextFieldVentaId;
